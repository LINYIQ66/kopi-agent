...
def cli_instance(tmp_path, session_db):
    """Create a minimal KopiCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        KopiCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        KopiCLI._handle_branch_command(cli_instance, "/branch refactor approach")
