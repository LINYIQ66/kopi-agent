"""Tests for ``KopiCLI._prompt_text_input`` thread-safe input dispatch.
...
def _make_cli():
    """Minimal KopiCLI shell exposing prompt fallback helpers."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.KopiCLI)
    obj._app = MagicMock()
