...
class TestProviderModelIds:
    ...
    def test_copilot_falls_back_to_curated_defaults_without_stale_opus(self):
        with patch("kopi_cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
             patch("kopi_cli.models._fetch_github_models", return_value=None):
...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a Kopi User-Agent.
