...
class TestParserRegistry:
    ...
    def test_kopi_parser_registered(self):
        parsers = list_parsers()
        assert "kopi" in parsers
...
class TestKopiParser:
    @pytest.fixture
    def parser(self):
        return get_parser("kopi")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["kopi"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use kopi format since that's universal
