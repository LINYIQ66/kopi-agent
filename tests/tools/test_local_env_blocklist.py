...
Verifies that Kopi-managed provider, tool, and gateway env vars are
stripped from subprocess environments so external CLIs are not silently
misrouted or handed Kopi secrets.

See: https://github.com/XingBaoKu/kopi-agent/issues/1002
See: https://github.com/XingBaoKu/kopi-agent/issues/1264
"""
