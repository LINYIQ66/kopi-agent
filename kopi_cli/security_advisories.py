"""
Security advisory checker for KOPI O Agent.
...
run in environments where the rest of Kopi failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Kopi requires 3.10+ but defensive.
        return None
    try:
