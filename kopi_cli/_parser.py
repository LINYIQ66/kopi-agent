...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="kopi",
        description="KOPI O Agent - AI assistant with tool-calling capabilities",
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "Applies to -z/--oneshot and --tui. Also settable via KOPI_INFERENCE_PROVIDER env var."
        ),
    )
    parser.add_argument(
        "-t",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with KOPI O Agent",
    )
