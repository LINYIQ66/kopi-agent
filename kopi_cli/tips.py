...
TIPS = [
    ...
    "Ctrl+Z suspends Kopi to the background — run fg in your shell to resume.",
    ...
    "kopi mcp serve runs Kopi itself as an MCP server for other agents.",
    ...
    "kopi backup creates a zip backup of your entire Kopi home directory.",
    ...
    "kopi gateway install sets up Kopi as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Kopi tools programmatically — results stay out of context.",
    ...
    "When exiting, Kopi prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Kopi runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Kopi via a local macOS server.",
    ...
    "SOUL.md at ~/.kopi/SOUL.md is the agent's primary identity — customize it to shape behavior.",
    "Kopi loads project context from .kopi.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "kopi acp runs Kopi as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "kopi login supports OAuth-based auth for Nous and OpenAI Codex providers.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Kopi your own.",
    "SOUL.md is auto-seeded with a default personality on first run. Edit ~/.kopi/SOUL.md to customize.",
    ...
    "Before a gateway session reset, Kopi auto-flushes important facts to memory in the background.",
    ...
    "Each profile gets its own subprocess HOME at KOPI_HOME/home/ — isolated git, ssh, npm, gh configs.",
    ...
    "Skills from trusted repos (XingBaoKu) get a 'trusted' security level; community skills get extra scanning.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Kopi auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Kopi config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Kopi is working.',
    ...
    'kopi dashboard --tui embeds the full Kopi TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'KOPI_WRITE_SAFE_ROOT restricts write_file and patch to a directory prefix; writes outside require approval.',
    ...
    'kopi chat --ignore-user-config skips ~/.kopi/config.yaml — reproducible bug reports and CI runs.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Kopi block commands when the tirith scanner itself errors out.',
