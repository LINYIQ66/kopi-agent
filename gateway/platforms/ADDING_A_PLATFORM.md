...
There are two ways to add a platform to the Kopi gateway:
...
**zero changes to core Kopi code**.
...
Checklist for integrating a platform directly into the Kopi core.
