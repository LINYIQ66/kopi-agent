...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("KOPI_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. Kopi-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "(possibly OpenClaw or another Kopi instance). "
            "Kopi stopped Telegram polling after %d retries. "
            "Only one poller can run per token — stop the other process "
            "and restart with 'kopi start'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                from kopi_cli.commands import telegram_menu_commands
    ...
    async def send_typing(self, chat_id: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        ...
        if self._bot:
            try:
                ...
                # Skip the Bot API call entirely for Kopi-created DM topic
