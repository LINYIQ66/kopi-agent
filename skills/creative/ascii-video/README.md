...
Built for [KOPI O Agent](https://github.com/XingBaoKu/kopi-agent). Usable in any coding agent. Canonical source lives here; synced to [`XingBaoKu/kopi-agent/skills/creative/ascii-video`](https://github.com/XingBaoKu/kopi-agent/tree/main/skills/creative/ascii-video) via PR.
