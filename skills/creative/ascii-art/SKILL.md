...
```bash
python3 -m pyfiglet "KOPI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KOPI&font=Slant" | boxes -d stone
```
