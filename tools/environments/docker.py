...
#   SETUID/SETGID - the image entrypoint drops from root to the 'kopi'
...
class DockerEnvironment(BaseEnvironment):
    ...
    def _build_init_env_args(self) -> list[str]:
        ...
        # win over the generic Kopi secret blocklist. Only implicit passthrough
        # keys are filtered.
        forward_keys = explicit_forward_keys | (passthrough_keys - _KOPI_PROVIDER_ENV_BLOCKLIST)
