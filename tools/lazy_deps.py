"""
Lazy dependency installer for opt-in KOPI O Agent backends.

Many Kopi features (Mistral TTS, ElevenLabs TTS, Honcho memory, Bedrock,
...
(``kopi-agent[all]``) and install them eagerly at setup time. That has
two problems:
