...
const config: Config = {
  ...
  url: 'https://kopi-agent.happysocial.xyz',
  baseUrl: '/docs/',

  organizationName: 'XingBaoKu',
  projectName: 'kopi-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/XingBaoKu/kopi-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/kopi-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://kopi-agent.happysocial.xyz',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/XingBaoKu/kopi-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/XingBaoKu',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/XingBaoKu' },
            { label: 'GitHub Discussions', href: 'https://github.com/XingBaoKu/kopi-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/XingBaoKu/kopi-agent' },
            { label: 'Xing Bao Ku PTE LTD', href: 'https://happysocial.xyz' },
          ],
        },
      ],
      copyright: `Built by <a href="https://happysocial.xyz">Xing Bao Ku PTE LTD</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
