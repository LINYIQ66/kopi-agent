  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the KOPI O Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Kopi &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Kopi?{' '}
        <a
          href="https://github.com/XingBaoKu/kopi-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/XingBaoKu" target="_blank" rel="noopener noreferrer">
          Xing Bao Ku PTE LTD Discord
        </a>{' '}
