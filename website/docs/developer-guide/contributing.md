...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to KOPI O Agent — dev setup, code style, PR process"
---
...
- Building a custom/local tool without modifying Kopi core? Start with [Build a Kopi Plugin](../guides/build-a-kopi-plugin.md)
...
- **Profile-safe paths**: Never hardcode `~/.kopi` — use `get_kopi_home()` from `kopi_constants` for code paths and `display_kopi_home()` for user-facing messages. See [AGENTS.md](https://github.com/XingBaoKu/kopi-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/XingBaoKu](https://discord.gg/XingBaoKu)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/XingBaoKu/kopi-agent/blob/main/LICENSE).
