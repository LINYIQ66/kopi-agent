...
sidebar_position: 1
title: "Architecture"
description: "KOPI O Agent internals — major subsystems, execution paths, data flow, and where to read next"
---

# Architecture

This page is the top-level map of KOPI O Agent internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
- **`prompt_builder.py`** — Assembles the system prompt from: personality (SOUL.md), memory (MEMORY.md, USER.md), skills, context files (AGENTS.md, .kopi.md), tool-use guidance, and model-specific instructions
...
→ [Plugin Guide](/docs/guides/build-a-kopi-plugin), [Memory Provider Plugin](./memory-provider-plugin.md)
