...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to KOPI O Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Kopi tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Kopi core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a Kopi Plugin](/docs/guides/build-a-kopi-plugin)
