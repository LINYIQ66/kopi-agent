...
| Version | `1.1.0` |
| Author | KOPI O Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Kopi:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Kopi tools to understand the project:
