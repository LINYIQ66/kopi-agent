---
title: "KOPI O Agent — Configure, extend, or contribute to KOPI O Agent"
sidebar_label: "KOPI O Agent"
description: "Configure, extend, or contribute to KOPI O Agent"
---
...
authoritative list or see the [live slash commands reference](https://kopi-agent.happysocial.xyz/docs/reference/slash-commands).
...
User docs: https://kopi-agent.happysocial.xyz/docs/user-guide/features/curator

### Kanban (multi-agent work queue)

Durable SQLite board for multi-profile / multi-worker collaboration.
Users drive it via `kopi kanban <verb>`; dispatcher-spawned workers
see a focused `kanban_*` toolset gated by `KOPI_KANBAN_TASK` so the
...
Kopi's own env scrubber dropping `SYSTEMROOT` / `WINDIR` / `COMSPEC`
...
|----------------|----------|
| Config options | `kopi config edit` or [Configuration docs](https://kopi-agent.happysocial.xyz/docs/user-guide/configuration) |
| Available tools | `kopi tools list` or [Tools reference](https://kopi-agent.happysocial.xyz/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://kopi-agent.happysocial.xyz/docs/reference/slash-commands) |
| Skills catalog | `kopi skills browse` or [Skills catalog](https://kopi-agent.happysocial.xyz/docs/reference/skills-catalog) |
| Provider setup | `kopi model` or [Providers guide](https://kopi-agent.happysocial.xyz/docs/integrations/providers) |
| Platform setup | `kopi gateway setup` or [Messaging docs](https://kopi-agent.happysocial.xyz/docs/user-guide/messaging/) |
| MCP servers | `kopi mcp list` or [MCP guide](https://kopi-agent.happysocial.xyz/docs/user-guide/features/mcp) |
| Profiles | `kopi profile list` or [Profiles docs](https://kopi-agent.happysocial.xyz/docs/user-guide/profiles) |
| Cron jobs | `kopi cron list` or [Cron docs](https://kopi-agent.happysocial.xyz/docs/user-guide/features/cron) |
| Memory | `kopi memory status` or [Memory docs](https://kopi-agent.happysocial.xyz/docs/user-guide/features/memory) |
| Env variables | `kopi config env-path` or [Env vars reference](https://kopi-agent.happysocial.xyz/docs/reference/environment-variables) |
| CLI commands | `kopi --help` or [CLI reference](https://kopi-agent.happysocial.xyz/docs/reference/cli-commands) |
