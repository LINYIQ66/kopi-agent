...
Operate the Teams meeting summary pipeline via Kopi CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions.
...
Before using the pipeline, verify these are set in `~/.kopi/.env`:
