...
Set your Tenor API key in your environment (add to `~/.kopi/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/XingBaoKu/kopi-agent/blob/main/skills/media/gif-search/url)`
