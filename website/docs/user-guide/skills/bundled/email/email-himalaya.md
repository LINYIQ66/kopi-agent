...
To reply non-interactively from Kopi, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Kopi)** — pipe the message via stdin:
