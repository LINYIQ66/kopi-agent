...
description: "Connect KOPI O Agent to external tool servers via MCP — and control exactly which MCP tools Kopi loads"
---
...
4. Ask Kopi to use the MCP-backed capability.
...
| `enabled` | bool | If `false`, Kopi skips the server entirely |
