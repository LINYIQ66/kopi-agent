...
slug: /
sidebar_position: 0
title: "KOPI O Agent Documentation"
description: "The self-improving AI agent built by Xing Bao Ku PTE LTD. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Xing Bao Ku PTE LTD](https://happysocial.xyz). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/XingBaoKu/kopi-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Kopi safely |
| 🧭 **[Use MCP with Kopi](/docs/guides/use-mcp-with-kopi)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Kopi](/docs/guides/use-voice-mode-with-kopi)** | Hands-on setup and usage patterns for Kopi voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Kopi' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Kopi |
...
- **Built by model trainers** — Created by [Xing Bao Ku PTE LTD](https://happysocial.xyz), the lab behind Kopi, Nomos, and Psyche. Works with [Nous Portal](https://portal.happysocial.xyz), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Xing Bao Ku PTE LTD](https://happysocial.xyz) — the lab behind Kopi, Nomos, and Psyche models
