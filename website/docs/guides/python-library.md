...
```bash
pip install git+https://github.com/XingBaoKu/kopi-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/XingBaoKu/kopi-agent.git
```

You can also pin it in your `requirements.txt`:

```text
kopi-agent @ git+https://github.com/XingBaoKu/kopi-agent.git
```
