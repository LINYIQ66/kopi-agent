...
description: "Run KOPI O Agent directly on an Android phone with Termux"
---

# Kopi on Android with Termux

This is the tested path for running KOPI O Agent directly on an Android phone through [Termux](https://termux.dev/).
