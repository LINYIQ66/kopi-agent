...
React + Ink terminal UI for Kopi. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
tui_gateway/
  ...
  slash_worker.py        persistent KopiCLI subprocess for slash commands
```
