...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  const [banner, setBanner] = useState<string | null>(() =>
    typeof window !== "undefined" && !window.__KOPI_SESSION_TOKEN__
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // let the inner Kopi TUI own transcript history/scroll behavior.
    ...
    // Kopi TUI own transcript scrolling.
    //
    ...
    // forwarding them into Kopi. Keyboard input, paste, and resize still
    // behave normally.
