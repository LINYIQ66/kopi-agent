...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("kopi")
        class KopiToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "kopi", "mistral", "llama3_json")
...
from environments.tool_call_parsers.kopi_parser import KopiToolCallParser  # noqa: E402, F401
