...
- **Dataset (ours):** [XingBaoKu/openthoughts-tblite](https://huggingface.co/datasets/XingBaoKu/openthoughts-tblite)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `XingBaoKu/terminal-bench-2`  | `XingBaoKu/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
