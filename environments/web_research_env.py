...
Inspired by: GroceryMind — production Kopi agent doing live web research
             across German grocery stores (firecrawl + kopi-agent)
"""
...
# Ensure kopi-agent root is on path
...
class WebResearchEnvConfig(KopiAgentEnvConfig):
...
class WebResearchEnv(KopiAgentBaseEnv):
    """
