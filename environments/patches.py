"""
Monkey patches for making kopi-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by kopi_base_env.py).
