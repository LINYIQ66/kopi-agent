"""
KopiSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser kopi
    run-api
    python environments/kopi_swe_env.py serve \\
...
class KopiSweEnv(KopiAgentBaseEnv):
    ...
    name = "kopi-swe"
    env_config_cls = KopiSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[KopiSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = KopiSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="XingBaoKu/DeepKopi-3-Llama-3-3B-Preview",
            tool_call_parser="kopi",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="kopi-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="XingBaoKu/DeepKopi-3-Llama-3-3B-Preview",
