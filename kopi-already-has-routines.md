# KOPI O Agent Has Had "Routines" Since March
...
| | Claude Code Routines | KOPI O Agent |
|---|---|---|
...
KOPI O Agent is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.
...
Full automation templates gallery: [kopi-agent.happysocial.xyz/docs/guides/automation-templates](https://kopi-agent.happysocial.xyz/docs/guides/automation-templates)

Documentation: [kopi-agent.happysocial.xyz](https://kopi-agent.happysocial.xyz)

GitHub: [github.com/XingBaoKu/kopi-agent](https://github.com/XingBaoKu/kopi-agent)

---

*KOPI O Agent is built by [Xing Bao Ku PTE LTD](https://happysocial.xyz). Open source, model-agnostic, runs on your infrastructure.*
