...
Control the user's Spotify account via the Kopi Spotify toolset (7 tools). Setup guide: https://kopi-agent.happysocial.xyz/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `kopi auth spotify` again.
