...
# ---------------------------------------------------------------------------
# Provider ID mapping: Kopi ↔ models.dev
# ---------------------------------------------------------------------------

# Kopi provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Kopi (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Kopi provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Kopi agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Kopi provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Kopi ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Kopi or models.dev provider ID.  Tries exact match then
