...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Kopi also honours KOPI_CA_BUNDLE (its own convention)
...
# Minimum context length required to run KOPI O Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Kopi from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    "inference-api.happysocial.xyz": "nous",
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Kopi grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Kopi sends to providers:
