#!/usr/bin/env python3
"""
SWE Runner with Kopi Trajectory Format

A runner that uses Kopi-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Kopi-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Kopi-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Kopi format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Kopi-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Kopi-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Kopi Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Kopi-Agent's built-in execution environments
    and outputs trajectories in Kopi-Agent format.
    """
    ...
    def _convert_to_kopi_format(
        ...
        """
        Convert internal message format to Kopi trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Kopi trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Kopi trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Kopi Trajectory Format")
    print("=" * 60)
