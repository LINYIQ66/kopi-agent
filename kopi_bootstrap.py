"""Windows UTF-8 bootstrap for Kopi entry points.
...
should be imported at the very top of every Kopi entry point
(``kopi``, ``kopi-agent``, ``kopi-acp``, ``python -m gateway.run``,
