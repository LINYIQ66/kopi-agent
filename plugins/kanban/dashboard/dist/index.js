...
(function () {
  ...
  const DOCS_URL = "https://kopi-agent.happysocial.xyz/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://kopi-agent.happysocial.xyz/docs/user-guide/features/kanban-tutorial";
  ...
  const LS_BOARD_KEY = "kopi.kanban.selectedBoard";
    ...
    function onDown(e) {
      ...
      function move(ev) {
        ...
        if (col !== lastTarget) {
          ...
          if (col) col.classList.add("kopi-kanban-column--drop");
          lastTarget = col;
        }
      }
      function up() {
  ...
  function DocsLink() {
    return h("a", {
      ...
      title: "Open Kopi Kanban docs in a new tab",
      "aria-label": "Kopi Kanban documentation",
    }, "?");
  }
  ...
  function BoardToolbar(props) {
    ...
    return h("div", { className: "flex flex-wrap items-end gap-3" },
      ...
      h("div", { className: "flex flex-col gap-1",
                 title: "Filter by assigned Kopi profile. Profiles are the named agent identities that claim and work on tasks." },
  ...
  function BulkActionBar(props) {
    ...
    return h("div", { className: "kopi-kanban-bulk" },
      ...
      h("div", { className: "kopi-kanban-bulk-reassign",
                 title: "Reassign selected tasks to a different Kopi profile. Pick a profile (or unassign) and click Apply." },
        h(Select, {
          value: assignee,
  ...
  function BoardColumns(props) {
    ...
    return h("div", { className: "kopi-kanban-columns", onDragStart: handleDragStart, onDragEnd: handleDragEnd },
          ...
          h("div", { className: "kopi-kanban-card-row kopi-kanban-card-meta" },
            t.assignee
              ? h("span", { className: "kopi-kanban-assignee",
                            title: `Assigned to Kopi profile @${t.assignee}` }, "@", t.assignee)
      ...
      h("div", { className: "flex gap-2" },
        h(Input, {
          ...
          title: props.columnName === "triage"
            ? "Kopi profile that will spec this task (default: the dispatcher's configured specifier). Leave blank to let the dispatcher pick."
            : "Kopi profile to assign. Leave blank and the dispatcher will pick from available profiles when the task is Ready.",
