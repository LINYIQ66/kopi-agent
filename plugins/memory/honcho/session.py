...
class HonchoSessionManager:
    ...
    Runs alongside kopi' existing SQLite state and file-based memory,
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Kopi-side char cap before caching
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Kopi knows itself.
        try:
