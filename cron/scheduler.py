...
def _get_kopi_home() -> Path:
    """Resolve Kopi home dynamically while preserving test monkeypatch hooks."""
...
def run_job(job: dict) -> tuple[bool, str, str, Optional[str]]:
    ...
    try:
        ...
        try:
            load_dotenv(str(_get_kopi_home() / ".env"), override=True, encoding="utf-8")
        except UnicodeDecodeError:
            load_dotenv(str(_get_kopi_home() / ".env"), override=True, encoding="latin-1")
        ...
        prefill_file = os.getenv("KOPI_PREFILL_MESSAGES_FILE", "") or _cfg.get("prefill_messages_file", "")
        if prefill_file:
