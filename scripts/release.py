...
AUTHOR_MAP = {
    ...
    "teknium@happysocial.xyz": "teknium1",
    ...
    "274096618+kopi-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@happysocial.xyz": "shannonsands",
    ...
    "kopi@happysocial.xyz": "XingBaoKu",
    ...
    "ben@happysocial.xyz": "benbarclay",
    ...
    "emozilla@happysocial.xyz": "emozilla",
    ...
    "jonny@happysocial.xyz": "jquesnelle",
    ...
    "kopi@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "kopi@happysocial.xyz"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/XingBaoKu/kopi-agent",
    ...
    lines.append(f"# KOPI O Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for KOPI O Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="KOPI O Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  KOPI O Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"KOPI O Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"KOPI O Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'KOPI O Agent v{new_version} ({calver_date})' "
