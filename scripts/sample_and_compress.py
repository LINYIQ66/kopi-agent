...
DEFAULT_DATASETS = [
    "XingBaoKu/swe-terminus-agent-glm-kimi-minimax",
    "XingBaoKu/kopi-agent-megascience-sft1",
    "XingBaoKu/Kopi-Agent-Thinking-GLM-4.7-SFT2",
    "XingBaoKu/Kopi-Agent-Thinking-GLM-4.7-SFT1",
    "XingBaoKu/terminal-tasks-glm-kopi-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "XingBaoKu/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload XingBaoKu/{output_name} {final_output}")
