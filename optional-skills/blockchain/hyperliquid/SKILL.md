...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), KOPI O Agent
license: MIT
...
The script reads `~/.kopi/.env` for two optional defaults:
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.kopi/.env`.
