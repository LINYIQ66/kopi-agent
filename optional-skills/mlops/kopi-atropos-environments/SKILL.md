---
name: kopi-atropos-environments
description: Build, test, and debug KOPI O Agent RL environments for Atropos training. Covers the KopiAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the kopi-agent repo.
version: 1.1.0
author: KOPI O Agent
license: MIT
